...
_G.packer_plugins = {
  ...
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/Users/gabriel/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/Users/gabriel/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
  ...
  ["vim-table-mode"] = {
    loaded = true,
    path = "/Users/gabriel/.local/share/nvim/site/pack/packer/start/vim-table-mode",
    url = "https://github.com/dhruvasagar/vim-table-mode"
  },
  ["vscode.nvim"] = {
    loaded = true,
    path = "/Users/gabriel/.local/share/nvim/site/pack/packer/start/vscode.nvim",
